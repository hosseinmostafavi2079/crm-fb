...
class SystemConfig(models.Model):
    # تنظیمات پیامک
    sms_provider = models.CharField(max_length=100, blank=True, verbose_name="شرکت پنل پیامکی")
    sms_api_key = models.CharField(max_length=255, blank=True, verbose_name="کلید API")
    sms_line_number = models.CharField(max_length=50, blank=True, verbose_name="شماره خط فرستنده")
    ...
    backup_frequency = models.CharField(max_length=20, choices=BACKUP_SCHEDULE_CHOICES, default='daily', verbose_name="زمان‌بندی بکاپ")
    backup_retention_count = models.IntegerField(default=5, verbose_name="تعداد نگهداری فایل بکاپ")
    last_backup_at = models.DateTimeField(null=True, blank=True, verbose_name="آخرین بکاپ موفق")
